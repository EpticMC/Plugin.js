...
public class PJSConf {
    ...
    public void init() {
        ...
        for (ESVariable var : ESVariable.values()) {
            if (this.variableNames.containsKey(var)) variableNames.put(var, this.variableNames.get(var));
            else variableNames.put(var, var.getDefaultName());
        }
    ...
    public List<String> getScriptPath() { return scriptPath;     }
    public boolean isUseScriptScope()   { return useScriptScope; } //will force true in future

    public Map<String, String> getSystemProperties()  { return systemProperties; }
    public Map<ESVariable, String> getVariableNames() { return variableNames;    }
}
