package org.nulldev.pluginjs.comreg;
...
public final class CommandRegistration {
    ...
    public static PluginCommand registerCommand(Plugin plugin, String command) {
        ...
        catch (NoSuchMethodException ex)     { throw new UnsupportedOperationException(ex); } 
        catch (SecurityException ex)         { throw new UnsupportedOperationException(ex); } 
        catch (InstantiationException ex)    { throw new UnsupportedOperationException(ex); } 
        catch (IllegalAccessException ex)    { throw new UnsupportedOperationException(ex); } 
        catch (IllegalArgumentException ex)  { throw new UnsupportedOperationException(ex); } 
        catch (InvocationTargetException ex) { throw new UnsupportedOperationException(ex); }
    }
    ...
    public static void unregisterPluginCommands(Server server, Set<PluginCommand> commands) {
        ...
        catch (NoSuchFieldException ex)      { throw new UnsupportedOperationException(ex); }
    }
